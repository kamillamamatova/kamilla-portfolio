        ...
        <div className = "space-y-10">
            ...
            <section className = "grid grid-cols-2 gap-4 md:grid-cols-4">
                {[
                    ...
                    { label: "LeetCode Solved", value: "126"},
            ...
            <section className = "rounded-3xl border border-ink/10 bg-canvas/90 p-6 shadow-soft">
            ...
            <section className = "space-y-6">
                ...
                <div className = "relative border-l-2 border-ink/10 ml-3 space-y-8 py-2">
                    ...
                    <div className = "relative pl-8">
                        ...
                        <h3 className = "font-semibold text-ink">Mini Redis</h3>
                        <p className = "mt-1 text-sm text-ink/75">
                            Built a Redis-like TCP key-value store in Python with a custom RESP-style protocol.
                        </p>
                    </div>
            ...
            <section className = "grid gap-4 md:grid-cols-2">
                <div className = "rounded-3xl border border-ink/10 bg-canvas/90 p-6 shadow-soft">
